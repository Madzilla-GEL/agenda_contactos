        ...
        if (!Contactos.isEmpty()) {
            try {
                StringBuilder sb = new StringBuilder("Contactos ")
                        .append(Interfaz.ANSI_AMARILLO).append(nombre).append(Interfaz.ANSI_RESET);
                int index = 1;
                ...
                return "No hay contactos en la libreta " + Interfaz.ANSI_AMARILLO + nombre + Interfaz.ANSI_RESET + ".";
            }
        } else {
            return "No hay contactos en la libreta " + Interfaz.ANSI_AMARILLO + nombre + Interfaz.ANSI_RESET + ".";
        }
